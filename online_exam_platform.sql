...
--
-- Host: 127.0.0.1
-- Generation Time: May 26, 2022 at 11:50 PM
...
(32, 21, 'Design Pattern', '2022-05-25', '04:05:00', 2, 10),
(33, 20, 'Summer Quiz ', '2022-05-25', '08:00:00', 10, 15),
(34, 21, 'Winter Exam ', '2022-05-25', '11:11:00', 5, 5),
(35, 20, 'Practical Exam', '2022-05-25', '09:03:00', 2, 10),
(36, 20, 'engineering test', '2022-05-25', '09:41:00', 5, 6),
(37, 20, 'Practical ', '2022-05-25', '10:42:00', 2, 6);
...
(220, 32, 24, 1, 'choice', 'easy'),
(221, 32, 24, 2, 'choice', 'medium'),
(222, 32, 24, 0, 'choice', 'hard'),
(223, 32, 24, 1, 'true&false', 'easy'),
(224, 32, 24, 1, 'true&false', 'medium'),
(225, 32, 24, 0, 'true&false', 'hard'),
(226, 32, 25, 2, 'choice', 'easy'),
(227, 32, 25, 1, 'choice', 'medium'),
(228, 32, 25, 1, 'choice', 'hard'),
(229, 32, 25, 1, 'true&false', 'easy'),
(230, 32, 25, 2, 'true&false', 'medium'),
(231, 32, 25, 1, 'true&false', 'hard'),
(232, 33, 21, 1, 'choice', 'easy'),
(233, 33, 21, 2, 'choice', 'medium'),
(234, 33, 21, 3, 'choice', 'hard'),
(235, 33, 22, 2, 'true&false', 'easy'),
(236, 33, 22, 1, 'true&false', 'medium'),
(237, 33, 22, 1, 'true&false', 'hard'),
(238, 34, 24, 1, 'choice', 'easy'),
(239, 34, 24, 2, 'choice', 'medium'),
(240, 34, 24, 2, 'choice', 'hard'),
(241, 34, 25, 1, 'true&false', 'easy'),
(242, 34, 25, 1, 'true&false', 'medium'),
(243, 34, 25, 1, 'true&false', 'hard'),
(244, 35, 23, 1, 'choice', 'easy'),
(245, 35, 23, 1, 'choice', 'medium'),
(246, 35, 23, 1, 'choice', 'hard'),
(247, 35, 23, 1, 'true&false', 'easy'),
(248, 35, 23, 1, 'true&false', 'medium'),
(249, 35, 23, 0, 'true&false', 'hard'),
(250, 35, 22, 2, 'choice', 'easy'),
(251, 35, 22, 1, 'choice', 'medium'),
(252, 35, 22, 1, 'choice', 'hard'),
(253, 35, 22, 0, 'true&false', 'easy'),
(254, 35, 22, 0, 'true&false', 'medium'),
(255, 35, 22, 1, 'true&false', 'hard'),
(256, 36, 21, 1, 'choice', 'easy'),
(257, 36, 21, 1, 'choice', 'medium'),
(258, 36, 21, 1, 'choice', 'hard'),
(259, 37, 21, 1, 'choice', 'easy'),
(260, 37, 21, 1, 'choice', 'medium'),
(261, 37, 21, 2, 'choice', 'hard'),
(262, 37, 21, 1, 'true&false', 'easy'),
(263, 37, 21, 2, 'true&false', 'medium'),
(264, 37, 21, 0, 'true&false', 'hard');
...
(10, 'amr ali', '1618120190100093', 'amr@gmail.com', '$2y$10$/fe0rxhpRN0Rh1Z6XznTRuxIErUyrJrIJudQJjr9/10pU8WIFoZsC', 'professor', 1, '2022-05-16 15:47:37', '2022-05-25 17:37:04', 'dr.jpg'),
...
(197, 24, 'Can we create a clone of a singleton object?', 'true&false', 'easy', '2022-05-25 00:52:42'),
(198, 24, 'Integer class is an example of Decorator pattern.', 'true&false', 'medium', '2022-05-25 00:53:10'),
(199, 24, 'Which of the following pattern refers to creating duplicate object while keeping performance in mind?', 'choice', 'hard', '2022-05-25 00:56:43'),
(200, 24, 'Which of the following pattern provides a way to evaluate language grammar or expression?', 'choice', 'medium', '2022-05-25 00:58:16'),
(201, 24, ' Which of the following describes the State pattern correctly?', 'choice', 'hard', '2022-05-25 00:59:48'),
(202, 24, 'In which of the following pattern, a class behavior changes based on its state?', 'choice', 'easy', '2022-05-25 01:00:49'),
(203, 24, 'Which of the following describes the Front Controller pattern correctly?', 'choice', 'easy', '2022-05-25 01:02:28'),
(204, 24, 'Behavioral Design Pattern specifically concerned with communication between objects.', 'true&false', 'hard', '2022-05-25 01:03:19'),
(205, 24, 'MVC pattern is Model, View, Control.', 'true&false', 'medium', '2022-05-25 01:04:11'),
(206, 24, 'Which of the following is a design pattern?', 'choice', 'easy', '2022-05-25 01:05:37'),
(207, 25, 'You want to minimize development cost by reusing methods? Which design pattern would you choose?', 'choice', 'easy', '2022-05-25 01:12:48'),
(208, 25, ' You want to avoid multiple inheritance. Which design pattern would you choose?', 'choice', 'medium', '2022-05-25 01:13:46'),
(209, 25, 'The recurring aspects of designs are called design', 'choice', 'hard', '2022-05-25 01:16:50'),
(210, 25, 'Design pattern is a solution to a problem that occurs repeatedly in a variety of contexts.', 'true&false', 'easy', '2022-05-25 01:17:20'),
(211, 25, 'Singleton pattern not prevents one from creating more than one instance of a variable', 'true&false', 'medium', '2022-05-25 01:18:47'),
(212, 25, 'Facade pattern promotes weak coupling between subsystem and its clients.', 'true&false', 'hard', '2022-05-25 01:20:48'),
(213, 25, 'Facade pattern couples a subsystem from its clients.', 'true&false', 'easy', '2022-05-25 01:21:55'),
(214, 25, ' In factory method pattern, the framework must instantiate classes but it only knows about the abstract classes, which it cannot initiate. How would one solve this problem?', 'choice', 'hard', '2022-05-25 01:23:00'),
(215, 25, 'Which mechanism is applied to use a design pattern in an OO system?', 'choice', 'medium', '2022-05-25 01:24:39'),
(216, 25, 'Design patterns does not follow the concept of software reuse.', 'true&false', 'medium', '2022-05-25 01:25:03'),
(217, 23, 'The hardware equipment which you purchase and can modify it accordingly is called Open Source Hardware?', 'true&false', 'easy', '2022-05-25 01:46:49'),
(218, 23, 'What all percepts are required to create an Open Source Hardware so that any individual(Single entity/corporates) can utilize it and make a profit out of it? Choose all the correct options:', 'choice', 'medium', '2022-05-25 01:48:23'),
(219, 23, '\"Open Source Hardware should not restrict any user-no matter if used for commercial purpose from making profits out of the design or selling the Open Source Hardware Project\" This is a regulation followed by Open Source Hardware in which of the following percept?', 'choice', 'hard', '2022-05-25 01:49:25'),
(220, 23, 'Need-Announcement-Source Code the Cycle of Starting an Open Source Project', 'true&false', 'medium', '2022-05-25 01:50:40'),
(221, 23, 'Documentation can come in numerous ________ and can target various ________. Choose the correct options.', 'choice', 'hard', '2022-05-25 01:51:50'),
(222, 23, 'All the feedbacks that are received on an Open Source Project deal with Bugs and Errors?', 'true&false', 'hard', '2022-05-25 01:52:26'),
(223, 23, 'What makes your Open Source Project successful once Released?', 'choice', 'easy', '2022-05-25 01:53:54'),
(224, 23, 'What do you understand from GNOME and KDE?', 'choice', 'easy', '2022-05-25 01:54:59'),
(225, 23, 'Who was the founder of Linux?', 'choice', 'medium', '2022-05-25 01:56:19'),
(226, 23, ' Running Linux on your system requires a High-End System capable of high processing powers!', 'true&false', 'easy', '2022-05-25 01:56:53'),
(227, 22, 'Software is a product and can be manufactured using the same technologies used for other engineering artifacts.', 'true&false', 'easy', '2022-05-25 02:01:04'),
(228, 22, 'WebApps are a mixture of print publishing and software development, making their development outside the realm of software engineering practice', 'true&false', 'medium', '2022-05-25 02:01:40'),
(229, 22, 'In its simplest form an external computing device may access cloud data services using a web browser.', 'true&false', 'hard', '2022-05-25 02:02:06'),
(230, 22, 'Product line software development depends the reuse of existing software components to provide software engineering leverage.', 'true&false', 'easy', '2022-05-25 02:02:31'),
(233, 27, 'what is your ages', 'choice', 'medium', '2022-05-25 08:37:11'),
(234, 27, 'true false', 'true&false', 'medium', '2022-05-25 08:37:53'),
(236, 21, 'knp;kouf', 'choice', 'easy', '2022-05-25 09:39:25');
...
(11, 'alaa attia', '1618120190100091', 'alaaattia147@gmail.com', '$2y$10$zaLAYl8.oK/kyqJAMvG5HuuezNscl92XJiTNe9.Q/WLYOnXOEIk0y', 'three', 'SE', 'student', '2022-05-16 15:40:39', '2022-05-25 08:41:58', 15, 20, 'lola.jpg'),
