<header class="container" data-aos="fade-down">
    <nav class="navbar navbar-expand-lg vertical">
        <?php if (isset($_SESSION['image'])) { ?>
            ...
            <span class="fs-4 title"><a class="navbar-brand" <?php
                                                                if ($_SESSION['role'] == "student") { ?>href="student.php" <?php } else { ?> href="professor.php" <?php }
                                            ?>> Online Exams <br />
                        ...
                        ?>
                            <a class="nav-link" href="../Home/professor.php">
                                <?php if (isset($_SESSION['image'])) {
                                    ...
                                    <img class="profile-img" alt="professor" src="../profile-images/professors/prof.png">
                                <?php } ?>
                            </a>
                        ...
                        if ($_SESSION['role'] == "student") { ?>
                            <a class="nav-link" href="../Home/student.php">
                                <?php if (isset($_SESSION['image'])) {
                                    ...
                                    <img class="profile-img" alt="professor" src="../profile-images/professors/student.png">
                                <?php } ?>
                            </a>
                        <?php } ?>
                    </li>
