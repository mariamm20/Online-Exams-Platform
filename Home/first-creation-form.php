            ...
            <div class="form-section">
                <form action="../includes/create_exam.inc.php" method="Post">
                    ...
                    <fieldset class="inputs">
                        ...
                        <input type="text" placeholder="Exam Date" onfocus="(this.type='date')"
                            onblur="(this.type='text') ;" id="date" name="exam_date">

                        <input type="number" placeholder="Duration"  name="exam_duration"/>


                        <input type="text" placeholder="Exam Start Time" onfocus="(this.type='time')"
                            onblur="(this.type='text')" id="eye"  name="exam_start"/>
